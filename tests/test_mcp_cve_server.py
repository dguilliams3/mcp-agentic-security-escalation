...
def test_search_nvd(nvd_data):
    ...
    sample_desc = nvd_data[sample_cve_id].get("cve", {}).get("description", {}).get("description_data", [{}])[0].get("value", "")
...
def test_search_kevs(kev_data):
    ...
    search_term = sample_entry.get("vendorProject", "") or sample_entry.get("product", "") or "windows"
