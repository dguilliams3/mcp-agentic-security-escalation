...
if index_is_fresh(incidents_json, historical_out):
    ...
    print("✅ Saved Historical Incident Analyses index to data/vectorstore/incident_analysis_history\n")
...
if args.topk_test > 0:
    ...
    for doc, score in faiss_historical.similarity_search_with_score(
        "ransomware", k=args.topk_test
    ):
